...
public class ComputerGameStageFXML extends BorderPane {
    ...
    public void play(Label[][] labels, int row, int col, String myName, String opName) {
        if (labels[row][col].getText().isEmpty()) {
            ...
            if (check == 0) {
                computerTurn(labels, myName, opName);
            }
        }
    }
