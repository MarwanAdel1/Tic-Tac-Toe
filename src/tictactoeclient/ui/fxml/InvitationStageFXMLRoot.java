...
public class InvitationStageFXMLRoot extends BorderPane {
    ...
    public InvitationStageFXMLRoot() {
        ...
        opponentImageView= new ImageView();
        //myImageView= new ImageView(new Image(getClass().getResourceAsStream("myimage2.jpg")));
        //opponentImageView = new ImageView(new Image(getClass().getResourceAsStream("op_image.png")));
